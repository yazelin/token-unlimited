...
const SHELL = 'tu-shell-v47';   // v47: 目錄註記改成「卷一到此完結」
...
const WARM = [
  ...
  // 第八章（只有兩張自己的圖：蘿姆嬸的織布機與奧德的房間，其餘沿用六、七章）
  './第八章-閱讀版.html',
  './第八章-素材/1-織布機.webp', './第八章-素材/2-奧德的房間.webp',
  // 第九章（一張自己的夜景織布機，其餘沿用六、七、八章）
  './第九章-閱讀版.html',
  './第九章-素材/1-織布機夜.webp',
  // 終章（沒有自己的圖，全部沿用序、六、七、八章）
  './終章-閱讀版.html',
